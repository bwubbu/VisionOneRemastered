    ...
    <div class="col-lg-9" style="position: relative; left: 50%; transform: translateX(-50%); text-align: center;">
        ...
        <div class="row" style="padding-top: 20px; padding-bottom: 30px;">
            ...
            <div class="col-lg-6 wow fadeInRight justify-content-center" data-wow-delay="0.5s">
                <p class="mb-4">Vision One Sdn. Bhd. is a company that focuses on the provision of technical solution, inspection, nondestructive testing, maintenance and repair.
        ...
        <div class="row justify-content-center" style="padding-top: 20px; padding-bottom: 50px;">
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.5s">
                <p class="mb-4">The company is registered and accredited by national and international certifying bodies. The company composed of congregates
        ...
        <div class="row" style="padding-top: 20px; padding-bottom: 100px;">
            ...
            <div class="col-lg-6 wow fadeInRight justify-content-center" data-wow-delay="0.5s">
                <p class="mb-4">Vision One Sdn. Bhd. together with its associate companies will form collaborative
