    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="d-flex justify-content-center align-items-stretch" style="gap: px;">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s" style="margin-right: auto; margin-left: auto;">
                    <div class="team-item">
                        <div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.8s" style="margin-right: auto; margin-left: auto;">
                    <div class="team-item">
                        <div>
