...
/***/ "./source/_assets/js/jquery-1.10.2.min.js":
/*!************************************************!*\
  !*** ./source/_assets/js/jquery-1.10.2.min.js ***!
  \************************************************/
...
(function (e, t) {
  ...
  x.fn = x.prototype = {
    ...
    var e,
      ...
      u = arguments.length,
      c = !1;
    for ("boolean" == typeof s && (c = s, s = arguments[1] || {}, l = 2), "object" == _typeof(s) || x.isFunction(s) || (s = {}), u === l && (s = this, --l); u > l; l++) if (null != (o = arguments[l])) for (i in o) e = s[i], r = o[i], s !== r && (c && r && (x.isPlainObject(r) || (n = x.isArray(r))) ? (n ? (n = !1, a = e && x.isArray(e) ? e : []) : a = e && x.isPlainObject(e) ? e : {}, s[i] = x.extend(c, a, r)) : r !== t && (s[i] = r));
    return s;
  }, x.extend({
...
/******/ 	var __webpack_exports__ = __webpack_require__("./source/_assets/js/jquery-1.10.2.min.js");
/******/ 	
/******/ })()
;