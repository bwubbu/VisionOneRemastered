...
<div class="container-xxl">
    <div class="container">
        ...
        <div class="text-center mx-auto mb-1 wow fadeInLeft" data-wow-delay="0.9s" style="font-size: 15px">
        ...
        <div class="text-center mx-auto mb-1 wow fadeInLeft" data-wow-delay="1.3s" style="font-size: 15px">
        ...
        <div class="text-center mx-auto mb-1 wow fadeInLeft" data-wow-delay="1.7s" style="font-size: 15px">
        ...
        <div class="text-center mx-auto mb-1 wow fadeInLeft" data-wow-delay="2.1s" style="font-size: 15px">
            <a>Establish a reputation as an excellent local Malaysian solution provider.</a>
        </div>
        <div class="text-center mx-auto mb-1 wow fadeInLeft" data-wow-delay="2.5s" style="font-size: 15px">
